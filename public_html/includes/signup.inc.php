        ...
        <div class="container p-3">
            ...
            <form method="POST" action="<?php $_SERVER["PHP_SELF"] ?>">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="student-code" name="student-code" placeholder="Enter student code" required>
                </div>
                ...
                <div class="form-group form-row">
                    <div class="col">
                        ...
                        <input type="tel" class="form-control" id="telephone" name="telephone" placeholder="Enter telephone" required>
                    </div>
                    <div class="col">
                ...
                <div class="form-group form-row">
                    ...
                    <div class="col">
                        ...
                        <input type="password" class="form-control" id="verify-password" name="verify-password" placeholder="Re-enter password" required>
                    </div>
                </div>
